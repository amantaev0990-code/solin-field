const C='solin-live-v6-20260906-1';
const CORE=['./','./index.html','./styles.css?v=20260905-2','./app.js?v=20260906-1','./data-manifest.json','./data-meta.json','./manifest.webmanifest'];
